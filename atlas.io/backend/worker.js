      ...
      if (ptp) {
        ...
        if (psub === 'data' && method === 'GET') {
          return json({ ok: true, business: pr.name, brand: { color: pr.brand.color || '', logo: pr.brand.logo || '' },
            ...
            reviewed: !!(d.review && d.review.rating), reviewRating: (d.review && d.review.rating) || 0,   // G1: reviews are collectable in the SERVED portal, not just the owner's preview
